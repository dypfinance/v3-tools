...
const Footer = () => {
  ...
  return (
    ...
    <div className="py-4 flex-column flex-lg-row px-0 container-lg d-flex justify-content-between gap-3 align-items-start align-items-lg-center">
      <div className="d-flex flex-row flex-lg-column px-0 justify-content-between justify-content-lg-center align-items-center align-items-lg-start col-12 col-lg-6 gap-2">
        ...
        <a target={"_blank"} href="https://www.worldofdypians.com/" style={{position: 'relative'}}>
          <img src="/assets/img/metaverse.svg" alt="METAVERSE" style={{height: '30px'}}></img>
        </a>
      </div>
      <hr className="form-divider my-2 d-flex d-lg-none" style={{height: '2px'}} />
      <div className="social-and-links d-flex align-items-start align-items-lg-end flex-column-reverse flex-lg-column justify-content-center gap-4">
      ...
      <div className="footer-menu">
        ...
        <ul className='external-links'>
          ...
          <li>
              <a style={{ textDecoration: 'none' }}
              target={"_blank"}
              href="https://app.dypius.com/disclaimer"
            >
