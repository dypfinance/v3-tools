...
const ExplorerCard = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="explorercard-wrapper d-flex position-relative"
    >
      <div
        className="purplediv"
      ...
      <div className="col-12 col-lg-6 d-flex flex-column gap-3 justify-content-between">
        ...
        <div>
          ...
          Explore new dimensions of excitement that invite you to experience the thrill like never before!
          </h6>
        </div>
        <div className="">
