...
const EarnTopPicks = ({
  ...
  return topPools.length > 0 && expiredPools === false ? (
            ...
            windowSize.width > 1300 ? (
              ...
              <div className="px-0">
                <div className="top-picks-container">
                  ...
                  {activePools
                    .slice(0, topList === "Staking" && chain === "eth" ? 0 : 2)
                    .map((pool, index) => (
                      <TopPoolsCard
                        network={chainId}
                        display={
                ...
                //   listType={listType}
                // />
                null : activeCard && topList === "Vault" && chain === "eth" ? (
                  <Vault
                    vault={vaultArrayNew[cardIndex]}
                    token={tokenvaultArrayNew[cardIndex]}
                    platformTokenApyPercent={vaultplatformArrayNew[cardIndex]}
                  ...
                  {activePools.slice(6, 8).map((pool, index) => (
                    <TopPoolsCard
                      ...
                      onShowDetailsClick={() => {
                        ...
                        setActiveCard2(null);
                        setActiveCard3(null);
                        setActiveCard4(topPools[index + 4]);
                        setActiveCard5(null);
                        setActiveCard6(null);
                        setActiveCardNFT(false);
                        setActiveCardLandNFT(false);
            ...
            <div className="list-pools-container px-0">
              {cawsLandCard && topList === "Staking" && chain === "eth" && (
                <TopPoolsListCard
                  ...
                  totalNftsLocked={cawsLandCard.total_nfts_locked}
                  tokenName={"CAWS + WoD"}
                  apr={cawsLandCard.apy_percent + "%"}
                  tvl={"$" + getFormattedNumber(cawsLandCard.tvl_usd)}
                  lockTime={
                    cawsLandCard.lockTime
                      ? cawsLandCard.lockTime
                      : cawsLandCard.lock_time
                      ? cawsLandCard.lock_time
                      : locktimeFarm[0]
                  }
                  cardType={topList}
                  ...
                  showDetails={activeCardCawsLand}
                  topList={topList}
                  coinbase={coinbase}
                  cardIndex={0}
                  chainId={chainId}
    ...
    <div className={`row w-100 justify-content-center gap-4`}>
      {listing === "table" ? (
        windowSize.width > 1300 && !showRibbon ? (
          <div className="px-0">
            <>
              <div className="top-picks-container">
                {topList === "Staking" && chain === "eth" && (
                  <CawsCard
                    ...
                    isStaked={
                      userPools.length > 0
                        ? userPools.find(
                            (obj) =>
                              obj.contract_address === window.config.nft_address
                          )
                          ? true
                          : false
                        : false
        ...
        ) : windowSize.width > 786 && !showRibbon ? (
          <div className="px-0">
            <>
              <div className="top-picks-container">
                {topList === "Staking" && chain === "eth" && (
