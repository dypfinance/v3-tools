      ...
      <div className="row mt-4">
          ...
          <div className="whitelist-info-item d-flex flex-column w-100 p-3 h-100 justify-content-between">
            <div className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center justify-content-between w-100">
                ...
                <span className="available-claim-wod">
        ...
        <div className="col-12 col-lg-5 mt-2 mt-lg-0">
          <div className="d-flex flex-column gap-2 h-100">
            <div className="my-commitment-wrapper h-100 flex-column flex-lg-row py-4 px-3 w-100 d-flex  align-items-center justify-content-between gap-4">
              ...
              <div className="d-flex flex-column align-items-center gap-2">
                {" "}
                <h6 className="mb-0 my-commitment-value">
                  {getFormattedNumber(userVestedTokens)}
                </h6>
              ...
              <div className="d-flex flex-column align-items-center gap-2">
                {" "}
                <h6 className="mb-0 my-commitment-value">
                  {getFormattedNumber(userClaimedTokens)}
                </h6>
              ...
              <div className="d-flex flex-column align-items-center gap-2">
                {" "}
                <h6 className="mb-0 my-commitment-value">
                  {getFormattedNumber(userVestedTokens - userClaimedTokens)}
                </h6>
