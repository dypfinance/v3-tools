...
import kittyDash1 from "../assets/popupAssets/kittyDash1.png";
import kittyDash2 from "../assets/popupAssets/kittyDash2.png";
import kittyDash3 from "../assets/popupAssets/kittyDash3.png";
...
const KittyDashPopup = ({ active, onClose }) => {
  return (
    ...
    >
      ...
      <p className="games-popup-desc mb-0">
        In Kitty Dash, your goal is to run as fast as you can with your adorable
        cat while collecting coins and avoiding obstacles. The game is simple:
        swipe left or right to change lanes, swipe up to jump, and swipe down to
        slide. The longer you run, the higher your score climbs.
      </p>
      <p className="games-popup-desc mb-0">
        ...
        competitions allow you to compete for top spots on the leaderboards and
        earn exciting rewards. The more you play, the better your chances of
        climbing the ranks and claiming top prizes!
      </p>
      <div className="games-popup-image-wrapper p-2 d-flex  align-items-center justify-content-between gap-2">
      <img src={kittyDash1} style={{width: "32%"}} alt="" />
      <img src={kittyDash2} style={{width: "32%"}} alt="" />
      <img src={kittyDash3} style={{width: "32%"}} alt="" />
      </div>
